...
const resources = {
  en: {
    translation: {
      ...
      xlsxDisabledCsvAvailable: 'XLSX import is disabled. CSV files are still supported.',
  ...
  de: {
    translation: {
      ...
      xlsxDisabledCsvAvailable: 'XLSX-Import ist deaktiviert. CSV-Dateien werden weiterhin unterstützt.',
